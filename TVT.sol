...
contract BEP20 is Context, IBEP20, Ownable {
    uint256 private constant _preMineSupply = 7000000 * 1e18;
...
// Tivan token with Governance.
contract TVTtoken is BEP20('Tivan', 'TVT') {
    ...
    */
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "TVT: _addMinter is the zero address");
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "TVT: _delMinter is the zero address");
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getMinterLength() - 1, "TVT: index out of bounds");
